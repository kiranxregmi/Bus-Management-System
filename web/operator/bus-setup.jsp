...
<div class="container" style="padding:2rem 1rem;">
    <div style="display:flex;justify-content:space-between;gap:1rem;align-items:center;margin-bottom:1.5rem;">
        <div>
            <h2 style="color:var(--primary);">Operator Bus Setup</h2>
            <p style="color:var(--gray);">Configure assigned buses and open the Chalani seat map.</p>
        </div>
    ...
    <form action="${pageContext.request.contextPath}/operator/save-bus-setup" method="post" class="admin-panel">
